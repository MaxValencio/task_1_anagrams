...
public class AnagramImplTest {
    ...
    public void When_AnagramWithoutNonLettersIsEquals_Expect_isTrue() throws Exception{
    	AnagramImpl anagramByCollections = new AnagramImpl();
		String s = anagramByCollections.createAnagram("abcd efgh");
    ...
    public void When_AnagramWithNonLettersIsEquals_Expect_isTrue() throws Exception{
		AnagramImpl anagramByCollections = new AnagramImpl();
		String s = anagramByCollections.createAnagram("a1bcd efg!h");
    ...
    public void When_AnagramIsEquals_Expect_isTrue() throws Exception{
		AnagramImpl anagramByCollections = new AnagramImpl();
		String s = anagramByCollections.createAnagram("!!Sttt3uuu==@#ud31ennnt467 is a good programmer! Stu4&den(t 4464 =)");
